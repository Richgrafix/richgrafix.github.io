...
<title>Rich_Grafix || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">Rich_Grafix</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:kobinarichie1@gmail.com" style="color:#000000">kobinarichie1@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="RICHARD KOBINA MENSAH" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/Bra Kobina" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Bra Quobina</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+233543167119</h4>
		<h4 style="font-family:'typo' ">kobinarichie1@gmail.com</h4>
		<h4 style="font-family:'typo' ">Odoben Presby "B" Basic school</h4></div></div>
		</p>
      </div>
